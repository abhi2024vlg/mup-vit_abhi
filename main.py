### This is⁠ Modified BaseLine with 17 registers ,positional embedding ⁠ but with the old initialization
...
wandb.init(project="fractual_transformer", name="ImageNet100_Modified_Baseline_run_PE_10000_old_init.")
